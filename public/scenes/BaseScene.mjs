...
export class BaseScene extends Phaser.Scene {
    ...
    createFold() {
        ...
        this.foldText = this.add.text(0, 250, `0`, { font: "normal 18px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        this.foldText.setVisible(false);
        this.foldText.setAlpha(1);

        this.foldTitle = this.add.text(0, 170, `0`, { font: "bold 20px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
            ...
            this.tweens.add({
                ...
                onComplete: () => {
                    try {
                        ...
                        this.foldTitle.setX(myMap.get(this.fold[this.foldImgNumber]).xt);
                        this.tweens.add({
                            targets: [this.foldKeys, this.foldText, this.foldTitle],
                            alpha: 1,
                            duration: 250,
