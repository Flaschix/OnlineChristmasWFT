...
import { createUIBottom, createUITop, createUIRight, decrypt, createExitMenu, isMobile, HEIGHT_PRESS_X } from "../share/UICreator.mjs";
...
export class BaseScene extends Phaser.Scene {
    ...
    createFold() {
        ...
        this.foldText = this.add.text(0, 0, `0`, { font: "normal 36px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
