...
export class GameScene4 extends BaseScene {
    ...
    createOverlays() {
        const a = myMap.get('answer7');
        const b = myMap.get('answer8');
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FIRST_KEY) {
            ...
            this.title.setText('Вопрос 7')
            this.title.setVisible(true);
            this.paper.setVisible(true);
            if (this.fold.indexOf('answer7') == -1) {
                this.mySocket.emitAddNewImg('answer7');
            }
        }

        if (this.eventZone == LABEL_ID.SECOND_KEY) {
            this.secondKey.setVisible(true);
            this.title.setText('Вопрос 8')
            this.title.setVisible(true);
            this.paper.setVisible(true);
            if (this.fold.indexOf('answer8') == -1) {
                this.mySocket.emitAddNewImg('answer8');
            }
        }
