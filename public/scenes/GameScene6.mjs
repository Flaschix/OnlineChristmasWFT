...
export class GameScene6 extends BaseScene {
    ...
    createOverlays() {
        const a = myMap.get('pekinKey1');
        const b = myMap.get('pekinKey2');
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FIRST_KEY) {
            ...
            if (this.fold.indexOf('pekinKey1') == -1) {
                this.mySocket.emitAddNewImg('pekinKey1');
            }
        }
        ...
        if (this.eventZone == LABEL_ID.SECOND_KEY) {
            ...
            this.paper.setVisible(true);
            if (this.fold.indexOf('pekinKey2') == -1) {
                this.mySocket.emitAddNewImg('pekinKey2');
            }
        }
