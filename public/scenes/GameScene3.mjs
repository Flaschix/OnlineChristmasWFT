...
export class GameScene3 extends BaseScene {
    ...
    createOverlays() {
        ...
        this.fourthKey = this.add.text(a.x, 250, `${decrypt(a.text)}`, { font: "normal 18px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        ...
        this.closeButton.on('pointerdown', () => {
            ...
            this.tweens.add({
                targets: [this.closeButton, this.overlayBackground, this.fourthKey, this.emptyKey, this.paper, this.title1],
                alpha: 0,
                duration: 500,
                onComplete: () => {
                    try {
    ...
    hideOverlay() {
        this.isOverlayVisible = false
        if (this.fourthKey.visible) { this.fourthKey.setVisible(false); this.title1.setVisible(false); this.paper.setVisible(false); }
    ...
    itemInteract(context) {
        ...
        if (context.isInZone) {
            ...
            if (!context.isOverlayVisible) {
                ...
                context.tweens.add({
                    targets: [context.overlayBackground, context.closeButton, context.fourthKey, context.emptyKey, context.paper, context.title1],
                    alpha: 1,
                    duration: 500
                });
            }
