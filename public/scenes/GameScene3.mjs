...
export class GameScene3 extends BaseScene {
    ...
    createCollision() {
        ...
        const elf1 = this.matter.add.sprite(1204 + 32, 1326 + 42 - 468, 'elf4', null, {
            label: `${LABEL_ID.FIRST_KEY}`,
            isStatic: true,
            isSensor: true
        });

        const elf2 = this.matter.add.sprite(379 + 32, 1139 + 42 - 468, 'elf1', null, {
            label: `${LABEL_ID.SECOND_JOKE}`,
            isStatic: true,
            isSensor: true
        });

        const elf3 = this.matter.add.sprite(765 + 32, 1024 + 42 - 468, 'elf5', null, {
            label: `${LABEL_ID.FIRST_JOKE}`,
            isStatic: true,
            isSensor: true
        });

        const elf4 = this.matter.add.sprite(1592 + 32, 1047 + 42 - 468, 'elf3', null, {
    ...
    createOverlays() {
        ...
        //Первый ключ
        this.firstKey = this.add.image(this.cameras.main.width / 2, this.cameras.main.height / 2 + 10, 'tokioKey1');
        ...
        this.secondKey = this.add.image(this.cameras.main.width / 2, this.cameras.main.height / 2 + 10, 'tokioKey2');
