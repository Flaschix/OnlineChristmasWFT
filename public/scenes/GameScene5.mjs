...
export class GameScene5 extends BaseScene {
    ...
    createOverlays() {
        const a = myMap.get('sidneyKey1');
        const b = myMap.get('sidneyKey2');
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FIRST_KEY) {
            ...
            if (this.fold.indexOf('sidneyKey1') == -1) {
                this.mySocket.emitAddNewImg('sidneyKey1');
            }
        }
        ...
        if (this.eventZone == LABEL_ID.SECOND_KEY) {
            ...
            this.paper.setVisible(true);
            if (this.fold.indexOf('sidneyKey2') == -1) {
                this.mySocket.emitAddNewImg('sidneyKey2');
            }
        }
