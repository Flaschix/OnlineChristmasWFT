...
export class GameScene5 extends BaseScene {
    ...
    createOverlays() {
        const a = myMap.get('answer9');
        const b = myMap.get('answer10');
    ...
    showOverlay() {
        ...
        if (this.eventZone == LABEL_ID.FIRST_KEY) {
            ...
            this.title.setText('Вопрос 9')
            this.title.setVisible(true);
            this.paper.setVisible(true);
            if (this.fold.indexOf('answer9') == -1) {
                this.mySocket.emitAddNewImg('answer9');
            }
        }

        if (this.eventZone == LABEL_ID.SECOND_KEY) {
            this.secondKey.setVisible(true);
            this.title.setText('Вопрос 10')
            this.title.setVisible(true);
            this.paper.setVisible(true);
            if (this.fold.indexOf('answer10') == -1) {
                this.mySocket.emitAddNewImg('answer10');
            }
        }
