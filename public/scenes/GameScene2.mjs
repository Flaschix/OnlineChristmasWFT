...
export class GameScene2 extends BaseScene {
    ...
    createCollision() {
        ...
        const elf1 = this.matter.add.sprite(851 + 32, 1546 + 42, 'elf1', null, {
            label: `${LABEL_ID.FIRST_KEY}`,
            isStatic: true,
            isSensor: true
        });

        const elf2 = this.matter.add.sprite(478 + 32, 1039 + 42, 'elf2', null, {
            label: `${LABEL_ID.SECOND_JOKE}`,
            isStatic: true,
            isSensor: true
        });

        const elf3 = this.matter.add.sprite(966 + 32, 729 + 42, 'elf4', null, {
            label: `${LABEL_ID.FIRST_JOKE}`,
            isStatic: true,
            isSensor: true
        });

        const elf4 = this.matter.add.sprite(1351 + 32, 1027 + 42, 'elf3', null, {
    ...
    createOverlays() {
        ...
        //Первый ключ
        this.firstKey = this.add.image(this.cameras.main.width / 2, this.cameras.main.height / 2 + 10, 'newyorkKey1');
        ...
        this.secondKey = this.add.image(this.cameras.main.width / 2, this.cameras.main.height / 2 + 10, 'newyorkKey2');
