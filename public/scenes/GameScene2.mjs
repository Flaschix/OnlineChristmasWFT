...
export class GameScene2 extends BaseScene {
    ...
    createOverlays() {
        ...
        this.secondKey = this.add.text(a.x, 250, `${decrypt(a.text)}`, { font: "normal 18px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        ...
        this.thirdKey = this.add.text(b.x, 250, `${decrypt(b.text)}`, { font: "normal 18px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
        ...
        this.closeButton.on('pointerdown', () => {
            ...
            this.tweens.add({
                targets: [this.closeButton, this.overlayBackground, this.thirdKey, this.secondKey, this.emptyKey, this.paper, this.title1, this.title2],
                alpha: 0,
                duration: 500,
                onComplete: () => {
                    try {
    ...
    moveForwardRoom() {
        this.isInZone = false;
        this.eventZone = null;
        this.mySocket.emitSwitchScene(CST.SCENE.GAMESCENE3, 1054, 1860);
    }
    ...
    hideOverlay() {
        this.isOverlayVisible = false
        if (this.thirdKey.visible) { this.thirdKey.setVisible(false); this.title2.setVisible(false); this.paper.setVisible(false); }
        if (this.secondKey.visible) { this.secondKey.setVisible(false); this.title1.setVisible(false); this.paper.setVisible(false); }
    ...
    itemInteract(context) {
        ...
        if (context.isInZone) {
            ...
            if (!context.isOverlayVisible) {
                ...
                context.tweens.add({
                    targets: [context.overlayBackground, context.closeButton, context.thirdKey, context.secondKey, context.emptyKey, context.paper, context.title1, context.title2],
                    alpha: 1,
                    duration: 500
                });
            }
